...
public class PositionTestData {
    public static final TestMatcher<Position> POSITION_MATCHER = TestMatcher.usingIgnoringFieldsComparator(Position.class);
    ...
    public static Position getNew() {
        return new Position(null, "newPositionName", 50000);
    }

    public static Position getUpdated() {
        return new Position(POSITION_1_ID, "UpdatedPositionName", 54200);
    }
}