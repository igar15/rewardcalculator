...
public class EmployeeTestData {
    ...
    public static final int EMPLOYEE_1_ID = START_SEQ + 10;
    public static final int EMPLOYEE_2_ID = START_SEQ + 11;
    public static final int EMPLOYEE_3_ID = START_SEQ + 12;
