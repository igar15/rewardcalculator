...
public class EmployeeTestData {
    ...
    public static final Employee employee1 = new Employee(EMPLOYEE_1_ID, "John Doe", FULL_RATE, position1);
    public static final Employee employee2 = new Employee(EMPLOYEE_2_ID, "Jessica Parker", FULL_RATE, position1);
    public static final Employee employee3 = new Employee(EMPLOYEE_3_ID, "Bob Smith", FULL_RATE, position2);

    public static final Employee firedEmployee1 = new Employee(FIRED_EMPLOYEE_1_ID, "Jack Robinson", FULL_RATE, position1);
    public static final Employee firedEmployee2 = new Employee(FIRED_EMPLOYEE_2_ID, "Kristina Lee", FULL_RATE, position1);
    public static final Employee firedEmployee3 = new Employee(FIRED_EMPLOYEE_3_ID, "Mike Douglas", FULL_RATE, position2);
